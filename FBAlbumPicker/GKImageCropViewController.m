...
@synthesize previewImage, cropSize, delegate, sourceImageSize, sourceImageURL;
...
- (void)_actionUse{
  ...
  NSDictionary *dict = @{UIImagePickerControllerEditedImage: _croppedImage};
...
- (void)_setupCropView{
  ...
  self.imageCropView.imageSize = self.sourceImageSize;
    ...
    [self.imageCropView setCropSize:CGSizeMake(300, 300)];
