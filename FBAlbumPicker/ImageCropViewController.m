...
- (void)setupCancelButton {
  ...
  [self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"FBAlbumPicker.bundle/PLCameraSheetButton.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
  [self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"FBAlbumPicker.bundle/PLCameraSheetButtonPressed.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
...
- (void)setupUseButton {
  ...
  [self.useButton setBackgroundImage:[[UIImage imageNamed:@"FBAlbumPicker.bundle/PLCameraSheetDoneButton.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
  [self.useButton setBackgroundImage:[[UIImage imageNamed:@"FBAlbumPicker.bundle/PLCameraSheetDoneButtonPressed.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
